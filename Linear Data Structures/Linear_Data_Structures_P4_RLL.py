...
class linked_list:
    ...
    def reverse_display_ll(self):
        # crete an empty list
        elems_list = []

        # crete an empty list to store the reversed list
        rev_elems_list = []
        ...
        while current_node != None:
            # appends the data in each node to the list
            elems_list.append(current_node.data)
            # advances the current node to the next node
            current_node = current_node.next
        # for each element in the list of elements...
        # ...call the reversed function....
        # leanred reversed function from: https://stackoverflow.com/questions/529424/traverse-a-list-in-reverse-order-in-python
        for element in reversed(elems_list):
            # append the items in the list to another list, in reverse order
            rev_elems_list.append(element)
        # prints out the reverse linked list
        print(rev_elems_list)
