...
class create_student:
    ...
    def __init__(self, sign_show_duration):
        ...
        self.read_duration = randint(stud_read_start_time, stud_read_end_time)
        ...
        for schooldays in range(0, days_per_week):
            ...
            self.start_time_list.append(randint(1, 86400))
...
if __name__ == "__main__":
    ...
    def calc_signs_seen():
        ...
        # sorted attempts to sort but does 1 then 10 and so on...at this point, whatever
