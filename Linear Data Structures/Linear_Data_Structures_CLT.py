...
# * DESCRIPTION
# *===============================================
# File Name: Linear_Data_Structures_CLT.py
# W3
# CCOMP-12P
# Spring 2021
# *===============================================
...
appName = "Linear Data Structures CLT"
appVersion = "1.0.0"
appArch = "x86&x64"
appLang = "EN"
appScriptVersion = "1.0.0"
appScriptDate = "2021.03.04"
...
class linked_list:
    ...
    def list_type(self): determines what type of the list is being passed

    def node_count_reset(self): resets the 'watermark' in each node, used for counting
    '''
    ...
    # function to determine what type of list is being passed
    def list_type(self):
        # set the current node to the head, to start at the begining of the linked list
        cur_node = self.head
        ...
        # infinite loop
        while True:
            # for every node we go through, add +1 to the count
            cur_node.n_count += 1

            # if the current nodes.next value is none, the list must be terminating
            if cur_node.next == None:
                # print the type of list
                print(f"This is a terminating list. The end of the list is {cur_node}.")
                # call the node reset function for future lists
                self.node_count_reset()
                # escape the infinite while loop
                break
                # if the cur node is on the head and it has been seen more than twice before, it is a circle list.
            if cur_node == self.head and cur_node.n_count >= 2:
                # print the type of list
                print(f"This is a circle list. The head of the list contains {self.head} and was counted {cur_node.n_count} times.")
                # call the node reset function for future lists
                self.node_count_reset()
                # escape the infinite while loop
                break
            # if the current node has been seen more than 3 times and there is no head, it is a lollipop list.
            if cur_node.n_count >= 3:
                # print the type of list
                print(f"After visiting each node {cur_node.n_count} times; this list is a lollipop.")
                # call the node reset function for future lists
                self.node_count_reset()
                # escape the infinite while loop
                break
    ...
    # function to reset the count used in each node
    def node_count_reset(self):
        # set the current node to the head, to start at the begining of the linked list
        cur_node = self.head

        # while the current nodes count is greater than or equal to 1...
        while cur_node.n_count >= 1:
            # for every node we go through, reset the count to 0
            cur_node.n_count = 0

            # advanced to the next node
            cur_node = cur_node.next

            # if the list is a terminating list...
            if cur_node.next == None:
                # reset the count
                cur_node.n_count = 0
                # break the loop; otherwise it will throw a none type error
                break
...
if __name__ == "__main__":
    ...
    # determine what type of list is being called
    test_list.list_type()
